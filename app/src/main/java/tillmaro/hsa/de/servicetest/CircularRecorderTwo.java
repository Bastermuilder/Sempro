 ...
 * our video encoder.
 */
public class CircularRecorderTwo implements SurfaceTexture.OnFrameAvailableListener, SurfaceHolder.Callback {
...
//    private Activity mainActivity;
    ...
    private static class MainHandler extends Handler implements CircularEncoder.Callback {
        ...
        private WeakReference<CircularRecorderTwo> mWeakActivity;

        public MainHandler(CircularRecorderTwo activity) {
            mWeakActivity = new WeakReference<CircularRecorderTwo>(activity);
        }
        ...
        public void handleMessage(Message msg) {
            CircularRecorderTwo recorderService = mWeakActivity.get();
            ...
            switch (msg.what) {
//                case MSG_BLINK_TEXT: {
////                    TextView tv = (TextView) recorderService.findViewById(R.id.recording_text);
////
...
//                }
                ...
                case MSG_BUFFER_STATUS: {
                    ...
                    recorderService.updateBufferStatus(duration);
                    break;
                }
                default:
    ...
    public CircularRecorderTwo(Service service, Context context){
//                super.onCreate(savedInstanceState);
//        setContentView(R.layout.main);

//        this.mainActivity = mainActivity;
//        SurfaceView sv = (SurfaceView) mainActivity.findViewById(R.id.surfaceView);
...
//        AspectFrameLayout layout = (AspectFrameLayout) mainActivity.findViewById(R.id.continuousCapture_afl);
...
//        tv.setText(str);
        ...
        Toast toast = Toast.makeText(service, str, Toast.LENGTH_SHORT);
        toast.show();
    }
